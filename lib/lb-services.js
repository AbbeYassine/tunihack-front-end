     ...
     */
        ...
        R.services.create = function() {
          ...
          return action.apply(R, arguments);
            ...
            /**
             * @ngdoc method
             * @name lbServices.User.services#createMany
             * @methodOf lbServices.User.services
             *
             * @description
             *
        ...
        R.services.createMany = function() {
          var TargetResource = $injector.get("Service");
          var action = TargetResource["::createMany::User::services"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/services/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use User.services.createMany() instead.
            "::createMany::User::services": {
              isArray: true,
              url: urlBase + "/users/:id/services",
              method: "POST",
            },
